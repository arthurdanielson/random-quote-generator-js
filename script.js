...
/**
 * Generates a random quote and author and updates the DOM with the new values.
 */
function generate() {
  // Get an array of all the authors in the quotes object
  var authors = Object.keys(quotes);

  // Select a random author from the array
  var author = authors[Math.floor(Math.random() * authors.length)];

  // Get the quote corresponding to the selected author
